...
class BYTETracker:
    ...
    Methods:
        update(results, 0711img=None): Updates object tracker with new detections.
        get_kalmanfilter(): Returns a Kalman filter object for tracking bounding boxes.
        init_track(dets, scores, cls, 0711img=None): Initialize object tracking with detections.
