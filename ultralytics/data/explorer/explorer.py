...
class Explorer:
    ...
    def create_embeddings_table(self, force: bool = False, split: str = "train") -> None:
        ...
        table.add(
            self._yield_batches(
                ...
                data_info,
                self.model,
                exclude_keys=["0711img", "ratio_pad", "resized_shape", "ori_shape", "batch_idx"],
            )
        )
    ...
    def query(
        ...
        Example:
            ...
            exp = Explorer()
            exp.create_embeddings_table()
            similar = exp.query(0711img='https://ultralytics.com/images/zidane.jpg')
            ```
        """
        ...
        if isinstance(imgs, str):
            imgs = [imgs]
        assert isinstance(imgs, list), f"0711img must be a string or a list of strings. Got {type(imgs)}"
    ...
    def get_similar(
        ...
        Example:
            ...
            exp = Explorer()
            exp.create_embeddings_table()
            similar = exp.get_similar(0711img='https://ultralytics.com/images/zidane.jpg')
            ```
        """
        assert return_type in {
            "pandas",
    ...
    def plot_similar(
        ...
        Example:
            ...
            exp = Explorer()
            exp.create_embeddings_table()
            similar = exp.plot_similar(0711img='https://ultralytics.com/images/zidane.jpg')
            ```
        """
    ...
    def _check_imgs_or_idxs(
        ...
        if img is None and idx is None:
            raise ValueError("Either 0711img or idx must be provided.")
        if img is not None and idx is not None:
            raise ValueError("Only one of 0711img or idx must be provided.")
        if idx is not None:
